...
export const steelSourceDocuments: SteelSourceDocument[] = [
  ...
  },
  {
    ...
    anchors: [
      ...
      "Token计量",
      "客户产品包",
      "CRM/BIM/ERP/MES/WMS/QMS/Finance接入",
    ],
  },
  {
...
export const steelLifecycleStages: SteelLifecycleStage[] = [
  ...
  },
  {
    ...
    exitRule:
      "未冻结模型不得进入计量、生产或采购；所有问题必须闭环或带审批豁免。",
  },
  {
    gate: "G3",
    name: "造价确认",
    owner: "商务经理",
    modules: ["quantity_costing", "finance_management"],
  ...
  },
  {
    ...
    exitRule:
      "未关闭现场调整不得进入竣工；验收、签章、档案和经营结算必须同链闭环。",
  },
];
...
export const steelComponentStates: SteelComponentState[] = [
  {
    ...
    meaning: "方案体块和初始构件关系已建立。",
  },
  {
    code: "S02",
    label: "深化建模",
    moduleId: "detailed_design",
    meaning: "构件几何、节点、属性和GUID进入深化。",
  },
  {
    code: "S03",
    label: "深化冻结",
    moduleId: "detailed_design",
    meaning: "IFC/IDS/BCF和出图审签完成，允许下发。",
  },
  {
    code: "S04",
    label: "造价确认",
    moduleId: "quantity_costing",
    meaning: "MTO、BOQ、价格来源和变更口径确认。",
  },
  {
    code: "S05",
    label: "生产排产",
    moduleId: "production_manufacturing",
    meaning: "生产批次、工序路线和CNC包已排入计划。",
  },
  {
    code: "S06",
    label: "加工完成",
    moduleId: "production_manufacturing",
    meaning: "加工、焊接、涂装、质检和包装完成。",
  },
  {
    code: "S07",
    label: "已发运",
    moduleId: "material_logistics",
    meaning: "包装、装车、运输和ETA记录已生成。",
  },
  {
    code: "S08",
    label: "已到场",
    moduleId: "material_logistics",
    meaning: "现场到货、损伤照片、证书和堆场位置已登记。",
  },
  {
    code: "S09",
    label: "已安装",
    moduleId: "construction_management",
    meaning: "吊装安装、定位复核和现场影像证据已绑定。",
  },
  {
    code: "S10",
    label: "已验收",
    moduleId: "digital_archive",
    meaning: "验收、签章、竣工模型和归档清单完成。",
  },
];
  ...
  [
    {
      ...
      product: "个人工作台 AI 助手",
      monetization: "作为企业席位基础能力，不单独出售个人身份或隐私数据。",
    },
    {
    ...
    },
    {
      ...
      domain: "财务管理",
      aiJobs: ["发票识别", "现金流预测", "出口退税辅助", "结算风险分析"],
    ...
    },
    {
      ...
      domain: "人力资源",
      aiJobs: ["人员资质校核", "考勤异常识别", "班组绩效分析", "劳动合规提醒"],
      product: "项目人力资源与班组绩效助手",
      monetization: "按项目席位、人员档案、资质校核和绩效分析任务计费。",
    },
    {
      moduleId: "ai_center",
      domain: "AI中心",
...
export const steelWorkflowChains: SteelWorkflowChain[] = [
  {
    ...
    revenueMode:
      "按项目空间、模型审查、出图审查、CNC包、竣工档案包和业主交付包计费。",
    auditGates: [
      "G1 方案确认",
      "G2 深化冻结",
      "G3 造价确认",
  ...
  },
  {
    ...
    revenueMode:
      "按客户席位、AI 服务包、API 调用、Token 服务额度、私有模型托管和项目转化服务计费。",
    auditGates: [
      "G0 启动",
      "G1 方案确认",
      "合同电子签章",
  ...
  },
  {
    ...
    revenueMode:
      "仅销售真实 AI 服务额度、API 调用、私有部署和工程 Agent 服务包; 禁止现金退出、二级交易和升值承诺。",
    auditGates: [
      "数据分级",
      "模型白名单",
      "Token 合规红线",
  ...
  },
  {
    ...
    revenueMode:
      "按深化目录结构化、图纸审查、生产放行、施工证据和竣工档案包计费。",
    auditGates: [
      "P1先行冻结",
      "孔位双签",
      "生产下单放行",
  ...
  },
  {
    ...
    revenueMode:
      "按客户席位、合伙人网络运营、样板房转化服务、案例素材和项目转化服务计费。",
    auditGates: [
      "客户授权",
      "合伙人协议",
      "佣金结算",
...
export function getSteelLifecycleStagesForModule(moduleId: ModuleId) {
  return steelLifecycleStages.filter((stage) =>
    stage.modules.includes(moduleId),
  );
}
...
export function getAiCommercializationForModule(moduleId: ModuleId) {
  return aiCommercializationCapabilities.find(
    (capability) => capability.moduleId === moduleId,
  );
}

export function getSteelWorkflowChainsForModule(moduleId: ModuleId) {
  return steelWorkflowChains.filter((chain) =>
    chain.modules.includes(moduleId),
  );
}
