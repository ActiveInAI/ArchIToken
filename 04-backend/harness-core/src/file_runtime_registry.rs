...
pub fn list_file_runtime_routes() -> Vec<FileRuntimeRoute> {
    vec![
        ...
        route(
            ...
            "licensed_bim_adapter",
            FileProductionRoute::LicensedAdapterRequired,
            "Rhino 3DM is a source adapter; IFC/glTF/STEP derivatives are worker artifacts, and IFC must be emitted by a real sidecar.",
            &[
                "IFC mapping plan",
                "3DM->IFC sidecar contract",
                "STEP/glTF derivative contract",
            ],
            &[
                "Rhino Compute",
                "Speckle Rhino",
            ...
            "Requires configured Rhino/Speckle/enterprise adapter or PANAEC_3DM_TO_IFC_COMMAND.",
        ),
        route(
            "step",
            "step",
        ...
        route(
            ...
            "panaec_openusd",
            FileProductionRoute::ExternalProcessRequired,
            "OpenUSD is the preferred PanAEC Engine engineering scene exchange route; BIM semantics still require IFC/openBIM binding when BIM-derived.",
            &["OpenUSD", "IFC source binding when BIM-derived"],
            &["PanAEC Engine OpenUSD adapter", "OpenUSD"],
            "Routes to the PanAEC Engine OpenUSD/USDZ adapter; glTF/GLB is fallback only.",
        ),
        route(
            "usda",
            "usd",
            ...
            &["OpenUSD"],
            &["PanAEC Engine OpenUSD adapter", "OpenUSD"],
            "Routes to the same PanAEC Engine OpenUSD/USDZ path as .usd.",
        ),
        route(
            "usdc",
            "usd",
        ...
        route(
            ...
            "panaec_3dtiles",
            FileProductionRoute::AdapterRequired,
            "3D Tiles is a preferred PanAEC Engine streaming scene route; b3dm is a tileset payload, not a standalone semantic source.",
            &["OGC 3D Tiles", "tileset.json binding"],
            &["PanAEC Engine 3D Tiles runtime", "3d-tiles-renderer"],
        ...
        route(
            ...
            "panaec_3dtiles",
            FileProductionRoute::AdapterRequired,
            "3D Tiles is a preferred PanAEC Engine streaming scene route; i3dm is a tileset payload, not a standalone semantic source.",
            &["OGC 3D Tiles", "tileset.json binding"],
            &["PanAEC Engine 3D Tiles runtime", "3d-tiles-renderer"],
            "Serve only as part of an audited tileset.json graph.",
        ),
        route(
            ...
            "panaec_3dtiles",
            FileProductionRoute::AdapterRequired,
            "3D Tiles is a preferred PanAEC Engine streaming scene route; pnts is a point-cloud tileset payload.",
            &["OGC 3D Tiles", "tileset.json binding"],
            &["PanAEC Engine 3D Tiles runtime", "3d-tiles-renderer"],
            "Serve only as part of an audited tileset.json graph.",
        ),
        route(
            ...
            "panaec_3dtiles",
            FileProductionRoute::AdapterRequired,
            "3D Tiles is a preferred PanAEC Engine streaming scene route; cmpt is a composite tileset payload.",
            &["OGC 3D Tiles", "tileset.json binding"],
            &["PanAEC Engine 3D Tiles runtime", "3d-tiles-renderer"],
            "Serve only as part of an audited tileset.json graph.",
        ),
