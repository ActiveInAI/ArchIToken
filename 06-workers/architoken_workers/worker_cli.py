...
def production_self_check() -> dict[str, dict[str, object]]:
    ...
    return {
        ...
        "dwg_runtime": _runtime_any_check(
            "DWG ODA/LibreDWG sidecar or licensed adapter",
            env_names=(
                "DWG_ADAPTER_URL",
                "DWG_TO_DXF_PATH",
                "ODA_FILE_CONVERTER_PATH",
                "ARCHITOKEN_LIBREDWG_BIN",
                "LIBREDWG_BIN_DIR",
            ),
            binaries=("ODAFileConverter", "dwg2dxf", "dwgread", "FreeCADCmd", "FreeCAD"),
        ),
