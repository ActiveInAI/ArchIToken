...
**Product**: ArchIToken
**Scope**: AEC full-lifecycle operational platform, 16 modules, module workbench, file system, AI gates and digital twin
...
| Goal                     | Requirement                                                                                                                               |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Full lifecycle execution | 16 modules form a single chain from personal workspace and lead to archive                                                                |
...
| `settings_center`          | 人员, 账号, 密码, 头像, 单位, 岗位, 角色权限, 审计记录                                                                        | Platform identity policies                                                                      | All modules                                                                               | Identity directory, permission matrix, audit log     | `.json`, `.csv`, `.md`                                                           | Account change approval, permission approval, audit review                      |
...
| Module IDs     | 16 active IDs match registry; `planning_management`, `finance_management`, `human_resources`, and `ai_center` are active                                                                              |
