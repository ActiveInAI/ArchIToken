...
const officeWorker = policy({
  ...
  convert: route("worker", "adapter_required", "Explicit Office export worker"),
...
export const fileTypeRegistry = [
  ...
  fileType("openbim-ifc", "aec.bim.ifc", "IFC openBIM", [".ifc"], {
  ...
  fileType("openbim-ifczip", "aec.bim.ifc", "IFC ZIP package", [".ifczip"], {
    mimeType: "application/x-ifczip",
    viewerKind: "archive",
    adapters: ["ZIP central directory reader", "IfcOpenShell package worker"],
    stages: archiveNativePreview,
    productionRoute: "adapter_required",
  }),
  fileType("openbim-bcf", "aec.bim.bcf", "BCF issue package", [".bcf"], {
  ...
  fileType("openbim-bcfzip", "aec.bim.bcf", "BCF ZIP package", [".bcfzip"], {
    mimeType: "application/x-bcfzip",
    viewerKind: "archive",
    adapters: [
      "ZIP central directory reader",
      "buildingSMART BCF package worker",
    ],
    stages: archiveNativePreview,
    productionRoute: "adapter_required",
  }),
  ...
  fileType("cad-dxf-drawing", "cad.2d", "DXF drawing", [".dxf"], {
  ...
  fileType("vendor-sketchup", "vendor.sketchup", "SketchUp model", [".skp"], {
    ...
    viewerKind: "engineering",
    adapters: [
      "Speckle SketchUp adapter",
      "Blender isolated service",
      "licensed SketchUp runtime",
    ],
    stages: licensedVendor,
    productionRoute: "licensed_adapter_required",
  }),
  ...
  fileType(
    "gltf-runtime-fallback",
    "xr.model",
    "glTF/GLB runtime fallback",
    [".gltf", ".glb"],
    {
      mimeType: "model/gltf-binary",
      viewerKind: "engineering",
      adapters: [
        "source-bound glTF/GLB runtime",
        "Three.js GLTFLoader",
        "last fallback derivative for private source formats",
      ],
      stages: browserEngineering,
      productionRoute: "ready",
    },
  ...
  fileType(
    ...
    [".fcpxml", ".prproj", ".aep", ".drp"],
    {
      mimeType: "application/octet-stream",
      viewerKind: "text",
      adapters: ["OTIO/FFmpeg metadata worker", "DCC project adapter"],
      stages: externalProcess,
      productionRoute: "external_process_required",
    },
  ),
