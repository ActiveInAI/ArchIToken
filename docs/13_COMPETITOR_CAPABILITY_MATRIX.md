...
| CAD geometry | Strong CAD reference | BIM/CAD bridge reference | Data extraction reference | Viewer import reference | 3D runtime reference | Optimization reference | OCCT/FreeCAD/CadQuery/pythonocc/CGAL worker boundaries; DWG legal adapter boundary only. |
...
| 360 panorama / WebXR | Limited | Reference | Limited | Viewer reference | Viewer reference | Limited | Panorama graph, camera sync, WebXR adapter boundary, no proprietary renderer dependency. |
