...
export const zaofangMarketingProgram = {
  ...
  principle: '真实业务链路推进，杜绝形式化操作；每一步明确目标、流程、标准和可追溯证据。',
  flow: '线上冷启动挖掘0号合伙人 -> 线下合伙人破局 -> 合伙人赋能 -> 口碑引爆 -> 样板房成交 -> 口碑裂变循环',
  targetRegions: ['杭州重点乡镇', '上海重点乡镇', '宁波重点乡镇'],
  sampleHouseAnchor: '每个乡镇 1 个核心样板房选址；已确定濮院星旗镇体验销售中心。',
  conversionSla: '企业微信客户咨询 24 小时内响应；客户签约后每周至少 2 次同步施工进度。',
};
...
export const zaofangMarketingPreflight: ZaofangMarketingPreflightItem[] = [
  {
    id: 'target-township',
    title: '确定核心目标区域',
    standard: '杭州、上海、宁波各 1 个重点乡镇，每个乡镇 1 个核心样板房选址，覆盖周边 2-3 个行政村镇。',
  ...
  },
  {
    ...
    standard: '主标题、样板房图视频、核心优势、产品说明、全流程拆解、合伙人政策、本地案例预留、企微二维码和预约入口必须齐备。',
  ...
  },
  {
    id: 'partner-kit',
    title: '合伙人专属物料',
    standard: '合作手册、收益测算表、授权牌、单页海报和样板房体验邀请卡必须在冷启动前准备完成。',
    evidence: ['合作手册', '收益测算表', '授权牌发放记录', '物料版本'],
    moduleIds: ['marketing_service', 'finance_hr', 'digital_archive'],
  },
  {
    id: 'wechat-sop',
    title: '企业微信承接体系',
  ...
  },
  {
    ...
    title: '样板房标准化布置',
    standard: '实景展示、AR 透视、数据看板、工艺展示区、接待区必须可看、可摸、可体验、可验证。',
    evidence: ['样板房验收清单', 'AR 设备配置', '数据看板', '工艺样品照片'],
    moduleIds: ['marketing_service', 'construction_management', 'digital_twin', 'digital_archive'],
  },
];
...
export const zaofangMarketingStages: ZaofangMarketingStage[] = [
  {
    ...
    dayRange: 'D1-D14',
    objective: '用朋友圈本地推和抖音本地投放，让潜在合伙人主动认知造房网并筛选高意向0号种子合伙人。',
    coreActions: [
    ...
    moduleIds: ['marketing_service', 'planning_management', 'ai_center', 'digital_archive'],
  },
  {
    id: 'offline-partner-breakthrough',
    title: '线下破局：签约0号合伙人并搭建网络',
    dayRange: 'D14-D30',
    objective: '通过上门洽谈和样板房体验签约0号合伙人，再由0号合伙人带入设计机构、包工头、商会负责人和乡村意见领袖。',
    coreActions: [
    ...
    evidence: ['拜访纪要', '样板房体验记录', '合伙人协议', '合伙人档案', '服务群记录'],
    moduleIds: ['marketing_service', 'finance_hr', 'digital_archive', 'settings_center'],
  },
  {
    id: 'partner-enablement',
    title: '合伙人赋能：培训、考核和工具包',
    dayRange: 'D30-D45',
    objective: '解决合伙人不会推广、不敢推广的问题，让合伙人掌握项目讲解、朋友圈社群转发、带客和佣金查询方法。',
    coreActions: [
    ...
    evidence: ['培训签到', '考核记录', '工具包版本', '专属二维码', '一对一指导记录'],
    moduleIds: ['marketing_service', 'ai_center', 'digital_archive'],
  },
  {
    ...
    dayRange: 'D45-D60',
    objective: '打造 1-2 个本地标杆客户，通过合伙人圈层传播，让 C 端客户主动添加企业微信咨询。',
    coreActions: [
    ...
    evidence: ['标杆客户协议', '拍摄素材', '案例视频', '合伙人转发记录', '客户咨询标签'],
    moduleIds: ['marketing_service', 'construction_management', 'digital_archive', 'finance_hr'],
  },
  {
    id: 'sample-house-close',
    title: '线下收口：样板房成交和裂变循环',
    dayRange: 'D46-D60+',
    objective: '用周末样板房集中接待解决最终顾虑，促成签约，并通过签约后服务引导客户二次裂变。',
    coreActions: [
    ...
    evidence: ['看房预约', '接待记录', '预算测算表', '签约合同', '施工进度群记录', '客户裂变线索'],
    moduleIds: ['marketing_service', 'finance_hr', 'construction_management', 'digital_archive'],
  },
];

export const zaofangMarketingBudget: ZaofangMarketingBudgetItem[] = [
  { item: '线上冷启动投放', amountRmb: 6000, note: '60 天三城合计小范围精准投放。' },
  { item: '合伙人拓展与体验', amountRmb: 20000, note: '拜访、体验、授权牌和本地网络建设。' },
  { item: '物料制作', amountRmb: 4000, note: '合作手册、收益测算表、单页、海报和政策手册。' },
  { item: '标杆案例打造', amountRmb: 550000, note: '样板房主体结构和硬装参考值；展示级样板房不是普通交付房。' },
  { item: '人工与杂费', amountRmb: 50000, note: '接待、拍摄、培训、交通和日常执行。' },
];
...
export function getZaofangMarketingStagesForModule(moduleId: ModuleId): ZaofangMarketingStage[] {
  return zaofangMarketingStages.filter((stage) => stage.moduleIds.includes(moduleId));
}
