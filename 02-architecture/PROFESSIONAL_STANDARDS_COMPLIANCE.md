...
|---|---|---|
| IPMP / IPMA 项目管理 | 项目目标、干系人、WBS、进度、资源、风险、变更、沟通、采购、质量和治理闭环 | `planning_management`, `construction_management`, `finance_hr`, `digital_archive` |
...
- 涉及预付款、定金、退款、税票、跨境支付、外汇、反洗钱、KYC/KYB、消费者保护和合同责任时,必须进入 `finance_hr` / `digital_archive` / `settings_center` 的财税、档案和权限审计边界。
