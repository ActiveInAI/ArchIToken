...
| 10 | `01-product/PRD.md` | 产品需求与模块能力边界 |
| 11 | `README.md` | 仓库入口与快速启动 |
...
ArchIToken 不是 CAD、BIM、造价、结构计算、CDE、数字孪生或项目管理的单点替代品,而是把这些工具、开放标准、工程文件、AI Agent、审批、审计和交付物串起来的开放工程智能操作层。
