...
- [x] 子域纳入 construction_supervision 模块清单、标准、数据模型、工作流和审计链。
...
- Monte Carlo kernel, IoT time-series storage, emergency WebSocket dispatch, weather-warning API, risk history base.
