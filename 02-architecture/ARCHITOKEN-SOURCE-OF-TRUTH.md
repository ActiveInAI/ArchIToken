...
| 2 | `02-architecture/CONSTITUTION.md` | 21 条工程宪法 |
| 3 | `02-architecture/MODULES.md` | 14 模块规范,与当前 Rust / 前端 registry 同步 |
| 4 | `02-architecture/MODULE-REGISTRY.md` | Module Registry 机制 |
| 5 | `02-architecture/ARCHITECTURE.md` | 全栈架构规范 |
| 6 | `01-product/PRD.md` | 产品需求与模块能力边界 |
| 7 | `README.md` | 仓库入口与快速启动 |
