...
export const moduleOperationalProfiles: Partial<Record<ModuleId, ModuleOperationalProfile>> = {
  ...
  marketing_service: {
    ...
    subtitle: '线上冷启动挖掘0号合伙人、线下合伙人破局、合伙人赋能、口碑引爆、样板房成交和裂变复盘。',
    features: [
      feature('landing-page', '官网/落地页8项收口', '主标题、样板房图视频、核心优势、流程拆解、合伙人政策、本地案例、企微二维码和预约入口。', '增长负责人', 'running', ['8项内容', '3城乡镇', '样板房1处']),
      feature('wechat-sop', '企业微信承接SOP', '自动欢迎语、避坑手册、样板房视频、本地政策摘要、预约系统和客户标签。', '企微顾问', 'ready', ['24h响应', '标签4类', '预约同步']),
      feature('zero-partner', '0号合伙人筛选', '官网停留3分钟、主动咨询合作、主动加微且响应积极，优先本地资源和公信力。', '合伙人经理', 'review', ['每城≥1个', '2-3个种子', '低质剔除']),
      feature('partner-network', '10-15个合伙人网络', '设计机构、包工头/施工队、同乡会/商会负责人、乡村意见领袖。', '渠道负责人', 'running', ['每城3-5个', '4类资源', '服务群']),
      feature('sample-house-close', '样板房10步转化', '实景参观、AR透视、触摸型材、数据对比、工期讲解、政策解读、预算测算、案例播放、签约。', '样板房接待', 'ready', ['2人接待', '10步流程', '周末集中']),
      feature('case-spread', '标杆案例传播', '1-2个本地标杆客户，开工到完工全程拍摄，合伙人每周转发2-3次。', '内容运营', 'running', ['1-2分钟视频', '5类圈层', '转发监督']),
    ],
    operations: [
      operation('build-partner-funnel', '生成合伙人漏斗', '已按官网停留、合作咨询、加微响应和本地资源筛选0号合伙人。'),
      operation('create-wechat-sop', '生成企微承接SOP', '已生成欢迎语、自动回复、预约提醒和客户标签字段。'),
      operation('issue-partner-kit', '发放合伙人工具包', '已生成合作手册、收益测算表、授权牌、二维码和转发文案模板。'),
      operation('plan-sample-house-day', '排周末样板房接待', '已按10步转化流程生成接待、测算、签约和跟进任务。'),
    ],
    statusTracks: ['前期准备', '线上冷启动', '线下破局', '合伙人赋能', '口碑引爆', '样板房成交', '裂变复盘'],
  },
  concept_design: {
  ...
  detailed_design: {
    ...
    subtitle: 'Q235B全栓接重钢装配式，8大专项、33个分组、P1/P2/P3分阶段冻结，工厂下单前锁定孔位和预埋。',
    features: [
      feature('ss-pack', '①重钢专项深化', '结构体系、全栓接节点、模块拆分和工厂加工图，钢构件下单前100%完成。', '重钢深化主师', 'running', ['42份', 'P1先行', '最高优先级']),
      feature('ar-pack', '②建筑土建深化', '取消砌体承重和外墙抹灰，全部改为钢骨架围护、装配式地坪、预制钢梯和工厂天沟。', '建筑深化设计师', 'review', ['25份', '钢构版', 'P2同步']),
      feature('id-pack', '③室内精装适配', '精装服从钢构模数、预埋前置、吊顶避梁、声桥切断和公差补偿。', '精装主案', 'running', ['33份', 'STC≥55', 'IIC≥55']),
      feature('mep-pack', '④机电综合改图', '管线沿梁侧排布，穿梁圆孔与SS-04-05一一对应，先BIM碰撞后下单。', '机电综合设计师', 'running', ['30份', '零碰撞确认', '双签锁定']),
      feature('env-fp-pack', '⑥⑦围护消防专项', 'ALC、一体板、气密水密、热桥断桥、防火包覆、喷淋排烟避梁和防火分区。', '围护/消防顾问', 'review', ['34份', '耐火极限', '气密线']),
      feature('con-pack', '⑧现场装配工艺', '吊装、调平、螺栓紧固、拼缝防渗、样板间试装、QC和安全文明施工。', '现场钢构代表', 'ready', ['18份', 'CON-01~03', '验收签字']),
    ],
    operations: [
      operation('register-drawing-catalog', '登记198份图纸目录', '已生成8大专项、33个分组和编号/阶段/岗位/优先级索引。'),
      operation('freeze-p1-package', '冻结P1先行包', '已锁定55份P1图纸、螺栓孔位、耳板尺寸和预留孔洞。'),
      operation('sync-mep-holes', '同步穿梁孔位', '已校核SS-04-05与MEP-02-01/02-04的穿梁圆孔和双签记录。'),
      operation('run-hotel-clash-check', '运行酒店碰撞检查', '已生成MEP、消防、吊顶和钢构节点BCF闭环清单。'),
    ],
    statusTracks: ['P1先行D1-D15', 'P2同步D15-D60', 'P3收口D40-D75', '孔位锁定', '制造移交', '施工工艺交底'],
  },
  quantity_costing: {
  ...
  material_logistics: {
    ...
    subtitle: '承接SS-04-08 BOM、SS-04-11构件编码、模块运输加固和现场进场核对，组织采购、包装、装车、物流、签收和堆场。',
    features: [
      ...
      feature('packing', '包装', '按构件号-方向-楼层-区域、吊装顺序、防护要求和二维码组织包装单元。', '物流经理', 'ready', ['SS-04-11', '包装单元', '二维码']),
      feature('loading', '装车', '按模块重心、运输限界宽≤3.9m/高≤4.5m、临时支撑和堆放支点安排装车。', '物流经理', 'running', ['宽≤3.9m', '高≤4.5m', '支点校核']),
    ...
    operations: [
      ...
      operation('arrange-logistics', '安排物流', '已按构件编码、模块重心、运输限界和吊装顺序生成装车计划与ETA。'),
      operation('receive-batch', '签收批次', '已更新构件物料进场核对、损伤照片、证书和现场堆放分区。'),
    ],
    statusTracks: ['BOM接收', '采购下单', '模块加固', '包装装车', '运输ETA', '到货签收', '堆场分区'],
  },
  production_manufacturing: {
    moduleId: 'production_manufacturing',
    title: 'Q235B全栓接酒店构件生产工作台',
    subtitle: '按SS-04加工深化、孔位坐标、BOM、无现场焊接、防腐防火、构件编码和包装发运组织MES工单。',
    features: [
      feature('p1-release', 'P1下单闸门', '重钢专项图纸、螺栓孔位、耳板尺寸和预留孔洞未冻结不得进厂排产。', '生产负责人', 'review', ['55份P1', '孔位锁定', '双签确认']),
      feature('shop-drawing', '钢构件加工详图', '钢柱、主梁、次梁每型下料长度、端头铣平、孔位坐标、公差0~-2mm。', '制图专员', 'running', ['SS-04-01~03', '0~-2mm', '圆孔']),
      feature('hole-cnc', '孔位CNC数据', '全部构件孔位统一坐标系，孔径公差+0.5mm，穿梁圆孔与MEP锁定表一致。', '数控工程师', 'running', ['SS-04-04', 'SS-04-05', 'CNC基础数据']),
      feature('factory-weld', '仅工厂焊接', '端板、加劲肋、吊耳和节点板在工厂焊接，现场安装保持全栓接。', '焊接工程师', 'ready', ['无现场焊接', '吊耳工厂焊', 'WPS/PQR']),
      feature('coating', '防腐防火涂装', '环氧富锌70μm、环氧云铁100μm、聚氨酯60μm，柱3h/梁2h/楼板1.5h。', '涂装工程师', 'review', ['3层涂装', '耐火分区', '环境记录']),
      feature('bom-code', 'BOM与包装编码', '构件编号、规格、单重、数量、材质Q235B、出厂顺序和构件号-方向-楼层-区域喷涂。', '物料统筹人员', 'running', ['SS-04-08', 'SS-04-11', '二维码追溯']),
      feature('factory-qc', '工厂质检放行', '尺寸、孔位、螺栓、涂装、防火和资料齐套后放行，异常进入返工闭环。', '质检工程师', 'review', ['孔位抽检', '膜厚记录', '资料齐套']),
    ...
    operations: [
      operation('release-p1-production', '校核P1生产放行', '已检查55份P1图纸、孔位锁定和双签确认，未冻结项进入阻断。'),
      operation('generate-bolt-hole-cnc', '生成孔位CNC包', '已生成圆孔孔位CSV、NC/DXF和模型版本绑定。'),
      operation('generate-q235b-bom', '生成Q235B BOM', '已生成构件编号、规格、单重、材质、出厂顺序和包装单元。'),
      operation('run-coating-qc', '运行涂装质检', '已核对防腐膜厚、防火耐火极限和环境温湿度记录。'),
    ],
    statusTracks: ['P1放行', '加工详图', '孔位CNC', '工厂焊接', '防腐防火', 'BOM编码', '包装发运'],
  },
  construction_management: {
    moduleId: 'construction_management',
    title: '100间精品酒店现场装配施工工艺工作台',
    subtitle: '按CON-01~03组织吊装、调平、螺栓紧固、拼缝防渗、干湿分区、样板间试装、物料进场、QC、安全和竣工资料。',
    features: [
      feature('hoisting', '吊装顺序', '柱→主梁→次梁→支撑，先内后外、先下后上，每步稳定性验算。', '现场钢构代表', 'review', ['CON-01-01', '每日安装量', '塔吊覆盖']),
      feature('leveling', '调平校准', '调平螺栓、柱顶水准仪测点、层间累积误差≤±5mm，每层复测。', '测量工程师', 'running', ['CON-01-02', '≤±5mm', '每层复测']),
      feature('bolt-torque', '高强螺栓紧固', '初拧50%→终拧100%，从中间向两端扩散，10%检验比例。', '栓接工艺顾问', 'running', ['CON-01-03', '10%抽检', '扭矩标记']),
      feature('seam-waterproof', '拼缝防渗隔声', 'PU密封胶、48kg/m³矿棉、背衬板、内饰收口按不可逆工序执行。', '防水防渗顾问', 'review', ['CON-01-04', '防水', '隔声']),
      feature('dry-wet-zones', '干湿作业分区', '灌浆、打胶、防水湿作业区与干作业区隔离，控制穿插窗口。', '现场精装代表', 'ready', ['CON-02-01', '穿插计划', '成品保护']),
      feature('mockup-release', '样板间试装放行', '3间样板间端头转角问题清单修正后才能批量施工。', '项目总工', 'blocked', ['3间样板间', '问题清单', '放行闸门']),
    ...
    operations: [
      operation('generate-hoisting-plan', '生成吊装顺序', '已按柱、主梁、次梁、支撑生成安装顺序和稳定性检查点。'),
      operation('record-bolt-torque', '登记螺栓紧固', '已登记初拧、终拧、扭矩标记和10%抽检记录。'),
      operation('release-mockup-room', '样板间放行校核', '已生成3间样板间问题清单、修正方案和批量施工放行意见。'),
      operation('archive-completion', '归档竣工资料', '已生成竣工图、检验批、隐蔽验收、材料合格证和功能检测缺项清单。'),
    ],
    statusTracks: ['吊装', '调平', '紧固', '拼缝', '干湿分区', '样板间', 'QC安全', '竣工资料'],
  },
  digital_twin: {
