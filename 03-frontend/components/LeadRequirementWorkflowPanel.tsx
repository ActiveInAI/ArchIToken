...
const geographyOptions = [
  loc("中国", [
    ...
    loc("天津市", [
      loc("天津市", [loc("和平区"), loc("滨海新区"), loc("武清区")]),
    ]),
    loc("上海市", [
      loc("上海市", [
        loc("浦东新区"),
    ...
    loc("河北省", [
      loc("石家庄市", [loc("长安区"), loc("裕华区")]),
      loc("唐山市", [loc("路北区"), loc("曹妃甸区")]),
    ]),
    loc("山西省", [
      loc("太原市", [loc("小店区"), loc("迎泽区")]),
      loc("大同市", [loc("平城区")]),
    ]),
    loc("内蒙古自治区", [
      loc("呼和浩特市", [loc("新城区"), loc("赛罕区")]),
      loc("包头市", [loc("昆都仑区")]),
    ]),
    loc("辽宁省", [
      loc("沈阳市", [loc("和平区"), loc("浑南区")]),
      loc("大连市", [loc("中山区"), loc("金普新区")]),
    ]),
    loc("吉林省", [
      loc("长春市", [loc("南关区"), loc("朝阳区")]),
      loc("吉林市", [loc("船营区")]),
    ]),
    loc("黑龙江省", [
      loc("哈尔滨市", [loc("道里区"), loc("南岗区")]),
      loc("齐齐哈尔市", [loc("龙沙区")]),
    ]),
    loc("江苏省", [
      loc("南京市", [loc("玄武区"), loc("江宁区")]),
      loc("苏州市", [loc("姑苏区"), loc("工业园区")]),
      loc("无锡市", [loc("滨湖区")]),
    ]),
    loc("浙江省", [
      loc("杭州市", [loc("西湖区", [loc("转塘街道")]), loc("余杭区")]),
      loc("宁波市", [loc("鄞州区")]),
      loc("温州市", [loc("鹿城区")]),
    ]),
    loc("安徽省", [
      loc("合肥市", [loc("蜀山区"), loc("包河区")]),
      loc("芜湖市", [loc("镜湖区")]),
    ]),
    loc("福建省", [
      loc("福州市", [loc("鼓楼区"), loc("仓山区")]),
      loc("厦门市", [loc("思明区"), loc("湖里区")]),
    ]),
    loc("江西省", [
      loc("南昌市", [loc("东湖区"), loc("红谷滩区")]),
      loc("赣州市", [loc("章贡区")]),
    ]),
    loc("山东省", [
      loc("济南市", [loc("历下区"), loc("市中区")]),
      loc("青岛市", [loc("市南区"), loc("崂山区")]),
    ]),
    loc("河南省", [
      loc("郑州市", [loc("金水区"), loc("郑东新区")]),
      loc("洛阳市", [loc("洛龙区")]),
    ]),
    loc("湖北省", [
      loc("武汉市", [loc("江岸区"), loc("武昌区"), loc("洪山区")]),
      loc("宜昌市", [loc("西陵区")]),
    ]),
    loc("湖南省", [
      loc("长沙市", [loc("岳麓区"), loc("天心区")]),
      loc("株洲市", [loc("天元区")]),
    ]),
    loc("广东省", [
      loc("广州市", [
    ...
    loc("广西壮族自治区", [
      loc("南宁市", [loc("青秀区"), loc("良庆区")]),
      loc("柳州市", [loc("城中区")]),
    ]),
    loc("海南省", [
      loc("海口市", [loc("龙华区"), loc("美兰区")]),
      loc("三亚市", [loc("吉阳区")]),
    ]),
    loc("四川省", [
      loc("成都市", [loc("锦江区"), loc("高新区")]),
      loc("绵阳市", [loc("涪城区")]),
    ]),
    loc("贵州省", [
      loc("贵阳市", [loc("南明区"), loc("观山湖区")]),
      loc("遵义市", [loc("红花岗区")]),
    ]),
    loc("云南省", [
      loc("昆明市", [loc("五华区"), loc("官渡区")]),
      loc("大理白族自治州", [loc("大理市")]),
    ]),
    loc("西藏自治区", [loc("拉萨市", [loc("城关区")])]),
    loc("陕西省", [
      loc("西安市", [loc("雁塔区"), loc("长安区")]),
      loc("咸阳市", [loc("秦都区")]),
    ]),
    ...
    loc("新疆维吾尔自治区", [
      loc("乌鲁木齐市", [loc("天山区"), loc("新市区")]),
      loc("喀什地区", [loc("喀什市")]),
    ]),
    loc("香港特别行政区", [
      loc("香港", [loc("中西区"), loc("九龙城区"), loc("沙田区")]),
    ]),
    loc("澳门特别行政区", [loc("澳门", [loc("花地玛堂区"), loc("大堂区")])]),
    loc("台湾省", [
      loc("台北市", [loc("信义区"), loc("大安区")]),
      loc("高雄市", [loc("苓雅区")]),
    ]),
  ]),
  loc("澳大利亚", [
    loc("西澳大利亚州", [
      loc("珀斯市", [loc("Perth CBD"), loc("Fremantle"), loc("Cannington")]),
    ]),
    loc("新南威尔士州", [
      loc("悉尼市", [loc("Sydney CBD"), loc("Parramatta")]),
    ]),
    loc("维多利亚州", [
      loc("墨尔本市", [loc("Melbourne CBD"), loc("Docklands")]),
    ]),
    loc("昆士兰州", [
      loc("布里斯班市", [loc("Brisbane CBD"), loc("South Brisbane")]),
    ]),
  ]),
  loc("美国", [
    loc("加利福尼亚州", [
      loc("洛杉矶县", [loc("Los Angeles")]),
      loc("圣克拉拉县", [loc("San Jose")]),
    ]),
    loc("纽约州", [loc("纽约市", [loc("Manhattan"), loc("Brooklyn")])]),
    loc("德克萨斯州", [
      loc("休斯敦市", [loc("Downtown Houston")]),
      loc("奥斯汀市", [loc("Downtown Austin")]),
    ]),
  ]),
  loc("加拿大", [
    loc("安大略省", [loc("多伦多市", [loc("Downtown Toronto")])]),
    loc("不列颠哥伦比亚省", [
      loc("温哥华市", [loc("Downtown Vancouver"), loc("Richmond")]),
    ]),
  ]),
  loc("英国", [
    loc("英格兰", [
      loc("伦敦", [loc("Westminster"), loc("Camden")]),
      loc("曼彻斯特", [loc("City Centre")]),
    ]),
    loc("苏格兰", [loc("爱丁堡", [loc("Old Town")])]),
  ]),
  loc("新加坡", [
    loc("新加坡", [loc("Central Region"), loc("Jurong East"), loc("Tampines")]),
  ]),
  loc("阿联酋", [
    loc("迪拜", [loc("Downtown Dubai"), loc("Business Bay")]),
    loc("阿布扎比", [loc("Al Reem Island")]),
  ]),
] satisfies LocationOption[];

const buildingFloorOptions = [1, 2, 3, 4, 5].map((value) => ({
  label: `${value}`,
  value,
}));
...
const fireOptions = ["一级", "二级", "三级", "四级"].map((value) => ({
  label: value,
  value,
}));
const seismicOptions = ["6度", "7度", "8度", "9度"].map((value) => ({
  label: value,
  value,
}));
...
const marketingRequirementDefaultValues = {
  budgetCurrency: "CNY",
  documentTemplateId: "standard_requirement",
  buildingStructure: "钢结构",
  fireResistanceRating: "二级",
  seismicIntensity: "7度",
  architecturalStyle: "现代简约",
} satisfies Partial<MarketingRequirementFormValues>;
...
async function fetchGeographyOptions(
  ...
  const response = await fetch(`/api/geo/locations?${search.toString()}`);
  if (!response.ok) {
    throw new Error(`行政区划加载失败: ${response.status}`);
  }
  const payload = (await response.json()) as { items?: LocationOption[] };
  return Array.isArray(payload.items) ? payload.items : [];
}

function geographyChildParams(
  option: LocationOption,
): Record<string, string> | null {
  if (option.level === "country" && option.countryCode) {
    return { level: "states", country: option.countryCode };
  }
  if (option.level === "state" && option.countryCode && option.stateCode) {
    return {
      level: "cities",
  ...
  if (
    option.level === "city" &&
    option.countryCode === "CN" &&
    option.areaCode
  ) {
    return { level: "districts", country: "CN", area: option.areaCode };
  }
  return null;
}
...
function MarketingRequirementCapture({
  ...
  const [status, setStatus] = useState<string>(
    "填写客户需求后写入后端 CDE / 数据库,供方案设计模块导入。",
  );
  const [submitting, setSubmitting] = useState(false);
  const [activeStep, setActiveStep] =
    useState<MarketingWorkflowStep>("inspiration");
  const [savedRequirement, setSavedRequirement] = useState<{
    record: MarketingRequirementRecord;
    file: ModuleFileNode;
  } | null>(null);
  const [confirmedScheme, setConfirmedScheme] =
    useState<ConceptSchemeOption | null>(null);
  const [locationOptions, setLocationOptions] =
    useState<LocationOption[]>(geographyOptions);
  const [locationLoading, setLocationLoading] = useState(true);
  const selectedDocumentTemplateId = Form.useWatch("documentTemplateId", form);

  useEffect(() => {
    form.setFieldsValue(marketingRequirementDefaultValues);
    form.setFieldValue("buildingFloors", undefined);
  }, [form]);

  useEffect(() => {
    let cancelled = false;
    void fetchGeographyOptions({ level: "countries" })
      .then((items) => {
      ...
      .catch((error: unknown) => {
        setStatus(
          `地理位置数据加载失败,已使用内置常用地区: ${describeError(error)}`,
        );
      })
      .finally(() => {
  ...
  const loadGeographyData: CascaderProps<LocationOption>["loadData"] = (
    selectedOptions,
  ) => {
    const targetOption = selectedOptions.at(-1);
    if (!targetOption || targetOption.isLeaf) return;

    const params = geographyChildParams(targetOption);
    if (!params) {
    ...
    setLocationOptions([...locationOptions]);
    void fetchGeographyOptions(params)
      .then((items) => {
        targetOption.children = items;
        targetOption.isLeaf = items.length === 0;
      })
      .catch((error: unknown) => {
        targetOption.children = [];
        targetOption.isLeaf = true;
        setStatus(`地理位置下级数据加载失败: ${describeError(error)}`);
      })
      .finally(() => {
        ...
        {activeStep === "intake" ? (
          <div className="arch-huly-step-card">
            ...
            <Form
              ...
              layout="vertical"
              size="small"
              initialValues={marketingRequirementDefaultValues}
              onFinish={submit}
            ...
            >
              ...
              {selectedDocumentTemplateId === "custom" ? (
                <Form.Item name="customTemplateNotes" label="自定义模板要求">
                  <Input.TextArea
                    rows={2}
                    placeholder="模板章节、固定条款、抬头页、签章区、PDF版式或字段占位要求"
                  />
                </Form.Item>
              ) : null}
              <Form.Item name="remarks" label="其它备注">
                <Input.TextArea
                  rows={3}
                  placeholder="偏好、约束、图纸状态、交付时间、审批要求等"
                />
              </Form.Item>
              <div className="arch-huly-form-actions">
                ...
                <Button type="primary" htmlType="submit" disabled={submitting}>
                  {submitting ? (
                    <ArchLoadingFlow label="提交中" size="inline" />
                  ) : null}
                  提交资料并进入参考图上传
                </Button>
              </div>
      ...
      {uploadedFiles.length > 0 ? (
        <div className="mt-3 grid gap-2">
          {uploadedFiles.map((file) => (
            <div
              key={file.id}
              className="arch-huly-row-muted flex items-center justify-between gap-3 rounded-md px-3 py-2"
            >
...
function ConceptSchemePanel({
  ...
  const [confirmedOptionId, setConfirmedOptionId] = useState<string | null>(
    null,
  );
  ...
  const generateOptions = useCallback(async () => {
    ...
    try {
      ...
      const job = await createConceptDesignGenerationJob(
        requirement,
        requirementFile,
        prompt,
      );
      const nextOptions = buildConceptSchemeOptions(
        requirement,
        nextRound,
        job,
      );
      const artifact = await persistConceptSchemeOptions(
        requirement,
        requirementFile,
        nextOptions,
        job,
      ...
      const nextRound = round + 1;
      const fallbackOptions = buildConceptSchemeOptions(
        requirement,
        nextRound,
        null,
      );
    ...
    <div className="rounded-md border border-[var(--arch-border)] p-3">
      ...
      <Form
        ...
        initialValues={{
          amount: requirement.budget
            ? Math.max(Math.round(requirement.budget * 0.1), 1)
            : 5000,
      ...
      >
        ...
        <Form.Item name="notes" label="付款备注">
          <Input.TextArea
            rows={2}
            placeholder="电子合同编号、电子签章主体、发票抬头、境内/境外支付说明;电子流程完成后可备注线下盖章安排"
          />
        </Form.Item>
        <Button type="primary" htmlType="submit" disabled={submitting} block>
          {submitting ? <ArchLoadingFlow label="生成中" size="inline" /> : null}
          生成意向定金支付意向
        </Button>
      </Form>
    </div>
...
function ConceptDesignRequirementImport({
  ...
  const [createdArtifactName, setCreatedArtifactName] = useState<string | null>(
    null,
  );
  const [message, setMessage] = useState(
    "选择一个市场客服 CDE 需求包,创建方案设计 text_to_bim 任务和方案输入工件。",
  );
  ...
  const readiness = selectedRecord
    ? buildConceptDesignReadiness(selectedRecord)
    : [];
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      const payload = await moduleFileApiClient.listModuleFiles(
        "marketing_service",
        {
          limit: 500,
        },
      ...
      const summaries = (
        await Promise.all(
          files.slice(0, 24).map(async (file) => {
            try {
              const content = await moduleFileApiClient.getModuleFileContent(
                file.id,
              );
        ...
        String(b.file.updatedAt).localeCompare(String(a.file.updatedAt)),
      );
      const visibleSummaries = dedupeRequirementSummaries(summaries).slice(
        0,
        5,
      );
      setRequirements(visibleSummaries);
      setSelectedFileId(
        (current) => current ?? visibleSummaries[0]?.file.id ?? null,
      );
      setMessage(
  ...
  async function importAndGenerate() {
    ...
    try {
      ...
      const artifact = await persistConceptImportArtifact(
        record,
        selected.file,
        run ?? planned,
        prompt,
      ...
      <div className="arch-huly-row rounded-md border p-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              type="primary"
              onClick={importAndGenerate}
              disabled={!selectedRecord || running}
            >
              {running ? (
                <ArchLoadingFlow label="生成中" size="inline" />
              ) : null}
              生成方案任务
            </Button>
          </div>
            ...
            <div className="grid h-full min-h-0 content-start gap-4">
              <div className="flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  ...
                  <h3 className="mt-1 text-[18px] font-medium leading-7 arch-text">
                    {selectedRecord.customerName}
                  </h3>
                  <p className="arch-muted arch-type-caption">
                    {selected?.file.name}
                  </p>
                </div>
              ...
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                <RequirementFact
                  label="项目位置"
                  value={selectedRecord.geoLocation}
                />
                <RequirementFact
                  label="建筑规模"
                  value={`${formatRequirementFloors(selectedRecord)} · ${formatArea(selectedRecord)}`}
                />
                <RequirementFact
                  label="结构/风格"
                  value={`${selectedRecord.buildingStructure ?? "结构待定"} · ${selectedRecord.architecturalStyle ?? selectedRecord.decorationStyle ?? "风格待定"}`}
                />
                <RequirementFact
                  label="预算"
                  value={formatBudget(selectedRecord)}
                />
              </div>
              ...
              <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_320px]">
                <div className="rounded-md border arch-border bg-[var(--arch-surface-muted)] p-4">
                  ...
                  <div className="mt-3 grid gap-2">
                    ...
                    <PipelineRow
                      label="任务类型"
                      value="concept_design / text_to_bim"
                    />
                    <PipelineRow
                      label="执行路径"
                      value="Planner -> Generator -> Evaluator -> RuleChecker -> SchemaValidator -> Approver"
                    />
                    <PipelineRow
                      label="输出工件"
                      value="方案生成任务 docx + GenerationJob trace"
                    />
                  </div>
                  {createdArtifactName ? (
                ...
                <div className="rounded-md border arch-border bg-[var(--arch-surface)] p-4">
                  ...
                  <div className="mt-3 grid gap-2">
                    {readiness.map((item) => (
                      <div
                        key={item.label}
                        className="flex items-center justify-between gap-3 arch-type-caption"
                      >
                        <span className="arch-text">{item.label}</span>
                        <span
                          className={
                            item.ready
                              ? "text-[var(--arch-success)]"
                              : "text-[var(--arch-warning)]"
                          }
                        >
                          {item.ready ? "已具备" : "需补充"}
                        </span>
              ...
              {selectedRecord.remarks ? (
                <div className="rounded-md border arch-border bg-[var(--arch-surface-muted)] p-4">
                  ...
                  <p className="mt-2 arch-type-body leading-6 arch-text">
                    {selectedRecord.remarks}
                  </p>
                </div>
              ) : null}
...
function dedupeRequirementSummaries(
...
function buildConceptDesignReadiness(
  record: MarketingRequirementRecord,
): Array<{ label: string; ready: boolean }> {
  return [
    {
      label: "客户和联系方式",
      ready: Boolean(record.customerName && record.phone),
    },
    { label: "项目位置", ready: Boolean(record.geoLocation) },
    {
      label: "建筑规模",
      ready: Boolean(
        record.buildingArea || record.buildingFloors || record.buildingScale,
      ),
    },
    {
      label: "结构或风格",
      ready: Boolean(
        record.buildingStructure ||
        record.architecturalStyle ||
        record.decorationStyle,
      ),
    },
    {
      label: "预算边界",
      ready: typeof record.budget === "number" && record.budget > 0,
    },
    {
      label: "AI 输出格式",
      ready: record.aiReadiness.preferredOutputs.length > 0,
    },
  ];
}
...
function RequirementFact({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border arch-border bg-[var(--arch-surface-muted)] p-3">
      ...
      <p
        className="mt-1 truncate arch-type-body font-medium arch-text"
        title={value}
      >
        {value}
      </p>
...
function PipelineRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="grid gap-1 rounded-md border arch-border bg-[var(--arch-surface)] px-3 py-2 md:grid-cols-[110px_minmax(0,1fr)]">
      ...
      <span
        className="min-w-0 truncate arch-type-caption arch-text"
        title={value}
      >
        {value}
      </span>
...
function formatArea(record: MarketingRequirementRecord): string {
  return typeof record.buildingArea === "number"
    ? `${record.buildingArea} m2`
    : "面积待定";
}
...
function formatRequirementFloors(record: MarketingRequirementRecord): string {
  if (typeof record.buildingFloors === "number")
    return `${record.buildingFloors} 层`;
...
function buildConceptSchemeOptionsDocument(payload: {
  ...
  const optionBlocks = payload.options
    .map((option) =>
      [
  ...
  return [
    ...
    `<script type="application/json" data-architoken-payload="${escapeHtml(payload.schema)}">${JSON.stringify(
      payload,
    )
      .replace(/</g, "\\u003c")
