...
SOURCE_BUILD_PROJECTS: dict[str, SourceBuildProject] = {
    ...
    "nvidia-cuda-toolchain": SourceBuildProject(
        ...
        label="NVIDIA CUDA workstation toolchain and runtime smoke",
        source_urls=(),
        ref="system-cuda",
        ...
        smoke=(("{prefix}/bin/architoken-cuda-smoke",),),
        outputs=("architoken-cuda-smoke", "CUDA runtime evidence"),
        notes=(
            "This is a real CUDA compile and runtime smoke for designer/developer NVIDIA workstations.",
            "If /dev/nvidia* is not visible, the smoke must fail and record evidence instead of being treated as success.",
        ),
    ),
