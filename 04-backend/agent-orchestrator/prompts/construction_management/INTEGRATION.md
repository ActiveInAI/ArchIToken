# construction_management · INTEGRATION
...
flowchart LR
    ...
    PM --> CS[construction_management<br/>9]
...
| 对接方式 | CSR 表 |
|---|---|
| `INSERT public.projects` · module_id 从 'marketing_service' → 'construction_management' | public.projects |
