...
export const planningDiagramTemplates = [
  template('gantt', '甘特图', ['横道图', '甘特-里程碑复合图'], 'schedule', 'd3-svg', ['task', 'milestone', 'resource'], '在线编制任务起止、依赖、进度和里程碑。', 'D3 SVG + PanUI form/table'),
  template('milestone', '里程碑图', ['节点计划图'], 'schedule', 'd3-svg', ['milestone', 'task'], '管理合同、设计、采购、生产、施工和交付关键节点。', 'D3 time scale'),
  template('wbs', 'WBS 工作分解结构图', ['工作分解结构图', '树状图'], 'mind', 'xyflow-react', ['wbs', 'task', 'raci'], '把项目目标拆解为可执行、可验收、可追责的工作包。', 'React Flow tree route'),
  template('raci', 'RACI 责任分配矩阵', ['责任矩阵图'], 'matrix', 'pan-ui', ['wbs', 'raci', 'approval'], '明确 Responsible、Accountable、Consulted、Informed。', 'PanUI Table'),
  template('kanban', '看板图', ['看板'], 'agile', 'pan-ui', ['task'], '按 todo、doing、review、blocked、done 管理计划任务流。', 'PanUI cards'),
  template('critical-path-network', '关键路径网络图', ['关键路径图', '关键路径网络图', '网络图'], 'network', 'xyflow-react', ['task', 'milestone'], '识别影响工期的依赖链和浮时风险。', 'React Flow directed graph route'),
  template('pert', 'PERT 图', ['PERT图', '三点估算网络图'], 'network', 'xyflow-react', ['task', 'risk'], '承载乐观/最可能/悲观工期和计划不确定性。', 'React Flow + simulation worker route'),
  template('resource-histogram', '资源直方图', ['资源负荷图', '资源负载图'], 'analytics', 'd3-svg', ['resource', 'task'], '按资源统计任务负载、冲突和峰值。', 'D3 SVG route'),
  template('risk-matrix', '风险矩阵图', ['优先矩阵图'], 'risk', 'd3-svg', ['risk', 'task'], '按概率和影响评估履约风险优先级。', 'D3 SVG scatter matrix'),
  template('burndown', '燃尽图', ['燃尽图'], 'agile', 'd3-svg', ['task'], '展示剩余任务量随时间下降趋势。', 'D3 SVG line route'),
  template('burnup', '燃起图', ['燃起图'], 'agile', 'd3-svg', ['task'], '展示已完成工作量和范围变化。', 'D3 SVG area route'),
  template('cumulative-flow', '累积流图', ['CFD'], 'agile', 'd3-svg', ['task'], '展示各状态任务堆积和瓶颈。', 'D3 SVG stacked area route'),
  template('velocity', '速度图', ['迭代速度图'], 'agile', 'd3-svg', ['task'], '展示周期交付能力和预测。', 'D3 SVG column route'),
  template('flowchart', '流程图', ['业务流程图'], 'flow', 'xyflow-react', ['task', 'approval'], '编制项目审批、变更、交付和归档流程。', 'React Flow route'),
  template('swimlane-flow', '泳道流程图', ['泳道图'], 'flow', 'xyflow-react', ['task', 'raci', 'approval'], '按部门/角色组织跨部门流程责任。', 'React Flow lane route'),
  template('bpmn', 'BPMN 业务流程建模标注图', ['BPMN'], 'flow', 'bpmn-js', ['task', 'approval'], '表达可执行或可审批的业务流程语义。', 'bpmn-js isolated adapter route'),
  template('mindmap', '思维导图', ['脑图'], 'mind', 'xyflow-react', ['wbs', 'risk'], '围绕项目目标、交付物、约束和风险做结构化展开。', 'React Flow mindmap route'),
  template('fishbone', '鱼骨图', ['因果图', '石川图'], 'quality', 'xyflow-react', ['risk', 'task'], '分析延误、质量、安全和成本问题根因。', 'React Flow custom graph route'),
  template('cause-effect-matrix', '因果矩阵图', ['因果矩阵'], 'quality', 'pan-ui', ['risk', 'task'], '把原因、影响、证据和责任人矩阵化。', 'PanUI Table'),
  template('pareto', '帕累托图', ['二八分析图'], 'quality', 'd3-svg', ['risk', 'task'], '找出造成主要延期/成本/质量问题的少数关键原因。', 'D3 SVG dual-axis route'),
  template('control-chart', '控制图', ['过程控制图'], 'quality', 'd3-svg', ['task', 'risk'], '监控进度、质量、成本指标是否失控。', 'D3 SVG line route'),
  template('trend', '趋势图', ['折线图', '趋势分析图'], 'analytics', 'd3-svg', ['task', 'risk'], '展示进度、成本、风险或资源指标趋势。', 'D3 SVG line route'),
  template('scatter', '散点图', ['相关分析图'], 'analytics', 'd3-svg', ['risk', 'resource'], '分析风险、资源、进度之间的相关性。', 'D3 SVG scatter route'),
  template('funnel', '漏斗图', ['转化漏斗'], 'analytics', 'd3-svg', ['approval', 'task'], '展示审批、问题闭环或交付物转化。', 'D3 SVG funnel route'),
  template('radar', '雷达图', ['蜘蛛网图'], 'analytics', 'd3-svg', ['risk', 'resource'], '比较项目管理能力、风险或资源维度。', 'D3 SVG radar route'),
  template('bubble', '气泡图', ['三变量散点图'], 'analytics', 'd3-svg', ['risk', 'resource'], '同时表达概率、影响和暴露规模。', 'D3 SVG bubble route'),
  template('histogram', '直方图', ['频率分布图'], 'analytics', 'd3-svg', ['task', 'resource'], '分析工期、成本或风险分布。', 'D3 SVG histogram route'),
  template('pie', '饼图', ['占比图'], 'analytics', 'd3-svg', ['task', 'resource'], '展示任务、成本或责任占比。', 'D3 SVG pie route'),
  template('column', '柱状图', ['柱形图'], 'analytics', 'd3-svg', ['task', 'resource'], '按阶段、资源、风险比较数量或工时。', 'D3 SVG column route'),
  template('bar', '条形图', ['横向柱状图'], 'analytics', 'd3-svg', ['task', 'resource'], '比较工作包、责任人、风险项。', 'D3 SVG bar route'),
  template('waterfall', '瀑布图', ['成本瀑布图'], 'analytics', 'd3-svg', ['task', 'resource'], '展示预算、变更、风险准备金和成本变动。', 'D3 SVG waterfall route'),
  template('s-curve', 'S 曲线图', ['S曲线图'], 'schedule', 'd3-svg', ['task', 'resource'], '展示计划、实际和预测累计进度/成本。', 'D3 SVG line route'),
  template('monte-carlo', '蒙特卡洛模拟分布图', ['工期概率分布'], 'risk', 'simulation-worker', ['task', 'risk'], '评估工期和成本的概率分布。', 'Rust/Python simulation worker route'),
  template('ccpm', '关键链项目管理图', ['CCPM'], 'network', 'xyflow-react', ['task', 'resource'], '管理资源约束、缓冲和关键链。', 'React Flow + schedule worker route'),
  template('value-stream', '价值流图', ['VSM'], 'lean', 'xyflow-react', ['task', 'resource'], '识别等待、返工、库存和非增值活动。', 'React Flow process route'),
  template('sipoc', 'SIPOC 模型图', ['SIPOC'], 'lean', 'pan-ui', ['task', 'resource', 'approval'], '梳理供应方、输入、过程、输出和客户。', 'PanUI Table + flow route'),
  template('story-map', '故事地图', ['用户故事地图'], 'agile', 'pan-ui', ['task', 'wbs'], '按用户旅程和交付批次组织需求。', 'PanUI cards'),
  template('affinity', '亲和图', ['KJ法'], 'quality', 'xyflow-react', ['risk', 'task'], '把问题、需求和风险归类聚合。', 'React Flow clustering route'),
  template('interrelationship', '关联图', ['关系图'], 'quality', 'xyflow-react', ['risk', 'task'], '识别问题之间的原因和影响关系。', 'React Flow graph route'),
  template('matrix-data-analysis', '矩阵数据分析图', ['矩阵图'], 'quality', 'pan-ui', ['risk', 'resource'], '用矩阵比较多维指标和对象。', 'PanUI Table + heatmap route'),
  template('arrow-diagram', '箭条图', ['箭线图'], 'quality', 'xyflow-react', ['task'], '表达任务活动顺序和依赖。', 'React Flow directed graph route'),
  template('pdpc', '过程决策程序图', ['PDPC'], 'quality', 'xyflow-react', ['risk', 'task'], '预演方案、风险、对策和替代路径。', 'React Flow tree route'),
  template('force-field', '力场分析图', ['推动阻碍分析'], 'strategy', 'pan-ui', ['risk', 'resource'], '分析推动因素和阻碍因素。', 'PanUI matrix'),
  template('boston-matrix', '波士顿矩阵图', ['BCG矩阵'], 'strategy', 'd3-svg', ['risk', 'resource'], '用于项目组合或资源投入优先级。', 'D3 quadrant'),
  template('swot', 'SWOT 分析矩阵图', ['SWOT'], 'strategy', 'pan-ui', ['risk', 'resource'], '分析优势、劣势、机会和威胁。', 'PanUI matrix'),
  template('logical-architecture', '逻辑架构图', ['架构图'], 'uml', 'xyflow-react', ['task', 'approval'], '表达系统、模块和业务逻辑依赖。', 'React Flow topology route'),
  template('org-chart', '组织结构图', ['组织图'], 'uml', 'xyflow-react', ['raci', 'resource'], '表达项目组织、岗位和授权链。', 'React Flow tree route'),
  ...
  template('data-flow', '数据流图', ['DFD'], 'flow', 'xyflow-react', ['task', 'approval'], '表达模块间数据输入输出和转换。', 'React Flow data-flow route'),
