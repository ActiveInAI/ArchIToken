...
**2026-05-15 定位同步**: ArchIToken 固定定位为 **Enterprise Open CDE + openBIM/Speckle Runtime + Module Workflow OS + AI Harness**。竞品边界与对标策略见 [`POSITIONING_AND_COMPETITIVE_STRATEGY.md`](./POSITIONING_AND_COMPETITIVE_STRATEGY.md).
...
|----|--------------|-------------|------|
| 产品定位 | AEC AI 工具 / BIM 应用 | **Enterprise Open CDE + openBIM/Speckle Runtime + Module Workflow OS + AI Harness** | 建设可私有化部署的开放工程 CDE、后端原生文件运行时和 AI 门禁系统 |
